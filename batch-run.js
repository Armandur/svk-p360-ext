...
// Körs på batch.html (extension page). Beror på:
//   batch-data.js (byggMallFrånRad, valideraRad)
//   batch-table.js (sättRadStatus)
//   batch-utils.js (hittaP360Flik, väntaPåNavigation, ärCaseDetailsUrl, skickaTillFlik,
//                   väntaPåBatchSignal, filTillBase64, förberedFiler)
